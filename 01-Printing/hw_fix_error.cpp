// Homework [3] : Find all errors and fix programm them.
#include <iostream>
using namespace std;

int main()
{
    cout << "Children must be tayght how to think, not what to think";
    cout << "We worry about what a child will become \"tomorrow\" yet we forget that he is someon today\n";
    cout << "We worry about what a child will become \"<\", yet we forget that he is someon today\n";
    cout << "We worry about what a child will become yet we forget that he is someon today." << endl;
    cout << "We worry about what a child will become yet we forget that he is someon today\n";
    cout << "Children need models gratter than critics\n";
    cout << "Children need models gratter than critics\n";
    cout << "Children need models gratter than critics\n";
    return 0;
}

// Programming : errors and fix
// #include<stream
// using namespace STD
